...
import { buildQueueKnowledgeCuration, buildListKnowledgeCurationHistory, buildKnowledgeProcessingProgress } from "@/application/knowledge/queue-knowledge-curation";
...
export const knowledgeProcessingProgress = buildKnowledgeProcessingProgress(knowledgeCandidateRepository);
export const knowledgeProcessingEnabled = knowledgeVerificationService !== undefined;
